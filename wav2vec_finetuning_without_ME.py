...
output_dir = os.environ.get(
    "OUTPUT_DIR",
    os.path.join(SCRIPT_DIR, "models", "wav2vec2_baseline")
)
...
training_args = TrainingArguments(
    ...
    # ⭐️ Baseline comparison model: no maximum-entropy regularization.
...
# ⭐️ TODO completed for baseline: use the plain Trainer, so this script trains
# without the Maximum Entropy novelty.
trainer = Trainer(
    model=model,
    args=training_args,
